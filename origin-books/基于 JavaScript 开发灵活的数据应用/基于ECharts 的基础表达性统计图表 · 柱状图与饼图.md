...
| --- | --- | --- | --- | --- |
| 本科录取人数 | ![N_A](https://juejin.cn/equation?tex=N_A) | ![N_B](https://juejin.cn/equation?tex=N_B) | ![N_C](https://juejin.cn/equation?tex=N_C) | ![N_D](https://juejin.cn/equation?tex=N_D) |
| 本科率 | ![P_A](https://juejin.cn/equation?tex=P_A) | ![P_B](https://juejin.cn/equation?tex=P_B) | ![P_C](https://juejin.cn/equation?tex=P_C) | ![P_D](https://juejin.cn/equation?tex=P_D) |

其中，我们假设数列 ![N](https://juejin.cn/equation?tex=N) 中的每一个元素都为大于 1000 小于 1500 的随机数，而数列 ![P](https://juejin.cn/equation?tex=P) 中的元素则为大于 0.85 小于 1 的随机数。同样，我们使用 JavaScript 生成一个符合这些约束的数据集，以便于学习。
