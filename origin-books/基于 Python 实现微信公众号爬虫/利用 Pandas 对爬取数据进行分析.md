...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/1/14/160f4bfd5f87c0d3~tplv-t2oaga2asx-image.image)

而 DataFrame 是增强型的二维数组，就像 Excel 中的表格，有行标签和列表索引，这种数据结构在Pandas 中最为常用。

![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/1/15/160f6ed775ea137d~tplv-t2oaga2asx-image.image)
...
关于Pandas更多详细的用法可以参考Pandas官方文档<https://pandas.pydata.org>，下一节我们将正式进入数据分析环节。
