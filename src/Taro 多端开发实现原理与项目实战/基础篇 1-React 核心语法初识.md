...
实际上，上述 JSX 代码，最终都会通过 JSX 编译器（现在主要都是 [babel](https://www.babeljs.cn/)），转换为 JS 代码。例如：
...
需要说明的是，由于微信小程序的限制，React 中某些写法和特性在 Taro 中还未能实现，后续将会逐渐完善。差异的部分可以在[《基础篇 4：Taro 开发说明与注意事项》](https://juejin.cn/book/6844733744830480397/section/6844733744922755085)章节里查看。
