...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/2/164599f30fae2a7f~tplv-t2oaga2asx-image.image)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/4/16464301a0e26416~tplv-t2oaga2asx-image.image)
...
使用时不要让实际元素远大于初始化大小，当实际元素开始超出初始化大小时，应该对布隆过滤器进行重建，重新分配一个 size 更大的过滤器，再将所有的历史元素批量 add 进去 \(这就要求我们在其它的存储器中记录所有的历史元素\)。因为 error\_rate 不会因为数量超出就急剧增加，这就给我们重建过滤器提供了较为宽松的时间。
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/4/16464885cf1f74c2~tplv-t2oaga2asx-image.image)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/7/5/164685454156e8e2~tplv-t2oaga2asx-image.image)
