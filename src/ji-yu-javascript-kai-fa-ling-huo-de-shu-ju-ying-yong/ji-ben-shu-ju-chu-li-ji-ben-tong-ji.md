...
数学期望值指的是在概率论中，一个数值集合总体中各种**可能性**的结合。举一个“栗子”，一个袋子中装有若干来自我国北方的板栗，以及若干来自我国南方的锥栗。那么经过**无限次**取出、记录并放回之后，我们可以假设计板栗为 `-1`，计锥栗为 `1`，经过简单的统计计算得出取出样本中板栗的概率 ![P_{\alpha}](https://juejin.cn/equation?tex=P_%7B%5Calpha%7D) 为 ![\frac{3}{5}](https://juejin.cn/equation?tex=%5Cfrac%7B3%7D%7B5%7D)，而锥栗的概率 ![P_\beta](https://juejin.cn/equation?tex=P_%5Cbeta) 为 ![\frac{2}{5}](https://juejin.cn/equation?tex=%5Cfrac%7B2%7D%7B5%7D)。

| 值 | 板栗（`-1`） | 锥栗（`1`） |
| :-- | :-- | :-- |
| 概率 ![P](https://juejin.cn/equation?tex=P) | ![\frac{3}{5}](https://juejin.cn/equation?tex=%5Cfrac%7B3%7D%7B5%7D) | ![\frac{2}{5}](https://juejin.cn/equation?tex=%5Cfrac%7B2%7D%7B5%7D) |

根据数学期望的计算公式可得，该袋子中栗子的期望值为 ![\text{-}\frac{1}{5}](https://juejin.cn/equation?tex=%5Ctext%7B-%7D%5Cfrac%7B1%7D%7B5%7D)。

![E=\text{-}1\times\frac{3}{5}+1\times\frac{2}{5}=\text{-}\frac{1}{5}](https://juejin.cn/equation?tex=E%3D%5Ctext%7B-%7D1%5Ctimes%5Cfrac%7B3%7D%7B5%7D%2B1%5Ctimes%5Cfrac%7B2%7D%7B5%7D%3D%5Ctext%7B-%7D%5Cfrac%7B1%7D%7B5%7D)

那么如果说我们假设这“**无限次**”的取出就是 **5** 次的话，就可以用这样的一个数组来表达记录的结果：`[ \-1, 1, \-1, \-1, 1 ]`，其中板栗 3 次，锥栗 2 次。使用我们以往学习平均数的计算方法来计算的话就是。

![m=\frac{\text{-}1+1+\text{-}1+\text{-}1+1}{5}=\text{-}\frac{1}{5}](https://juejin.cn/equation?tex=m%3D%5Cfrac%7B%5Ctext%7B-%7D1%2B1%2B%5Ctext%7B-%7D1%2B%5Ctext%7B-%7D1%2B1%7D%7B5%7D%3D%5Ctext%7B-%7D%5Cfrac%7B1%7D%7B5%7D)
