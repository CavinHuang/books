...
假设我们限定每一个单位时间内，当前值较前一个值的变化率绝对值不会超过 ![r \quad (0 < r < 1)](https://juejin.cn/equation?tex=r%20%5Cquad%20(0%20%3C%20r%20%3C%201))。

![\left| \frac{T_{i} - T_{i-1}}{T_{i-1}}\right| < r](https://juejin.cn/equation?tex=%5Cleft%7C%20%5Cfrac%7BT_%7Bi%7D%20-%20T_%7Bi-1%7D%7D%7BT_%7Bi-1%7D%7D%5Cright%7C%20%3C%20r)

那么我们便可以使用 JavaScript 中用于生成均匀分布在开区间 ![(0, 1)](https://juejin.cn/equation?tex=(0%2C%201))（不包含 0 与 1）随机数的 `Math.random()` 生成需要的随机数 ![rand](https://juejin.cn/equation?tex=rand)，然后通过以下公式得到一个均匀分布在区间 ![(-r, r)](https://juejin.cn/equation?tex=(-r%2C%20r)) 的随机系数。

![\text{coefficient} = 2r(rand - 0.5)](https://juejin.cn/equation?tex=%5Ctext%7Bcoefficient%7D%20%3D%202r(rand%20-%200.5))
...
![T_i = T_{i-1}*(1+\text{coefficient}) \quad (i=1,2,\cdots, n)](https://juejin.cn/equation?tex=T_i%20%3D%20T_%7Bi-1%7D*(1%2B%5Ctext%7Bcoefficient%7D)%20%5Cquad%20(i%3D1%2C2%2C%5Ccdots%2C%20n))
