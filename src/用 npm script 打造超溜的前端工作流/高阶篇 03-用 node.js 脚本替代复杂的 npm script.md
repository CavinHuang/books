...
- 在 exec 中也可以使用 npm script 运行时的环境变量的方式需要注意；
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2017/12/10/1603de95af9b2c41~tplv-t2oaga2asx-image.image)
